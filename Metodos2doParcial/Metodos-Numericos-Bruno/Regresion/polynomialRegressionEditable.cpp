...
int main(void) {
	int rows = 7; // Cambiado a 6 ya que tienes 6 filas en los datos de ejemplo
	...
	double nodes[7][2] = {{1.0 , -0.236}, {1.2 , 0.209},{1.5 , 0.853},{2.0 , 1.746}, {2.6 , 2.231}, {2.9 , 2.163}, {3.0 , 2.110}};
