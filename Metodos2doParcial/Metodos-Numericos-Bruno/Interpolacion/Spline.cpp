...
int main(int argc, char *argv[]) {
	double m[9][2] = {{1.00,0.098},{1.02,0.071},{1.1,-0.043},{1.23,-0.251},{1.35,-0.453},{1.5,-0.693},{1.7,-0.945},{1.86,-1.051},{2.0,-1.053}}; //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Aca cargo los datos X , Y
	int filas = 9; //poner aca la cantidad de filas de m. acordate que la cantidad de intervalos es filas-1
