...
void imprimirMatriz(double a[FILAS][COLUMNAS], double b[FILAS], int filas, int columnas);
...
void fileReader(double m[FILAS][COLUMNAS], int* filas, int* columnas) {
	...
	// Leer el archivo línea por línea y número por número
...
void triangulacion(double a[FILAS][COLUMNAS], double b[FILAS], double x[FILAS], int filas, int columnas) {
	...
	// Imprimir la matriz después de la triangulación
	printf("\nMatriz después de la triangulación:\n");
	imprimirMatriz(a, b, filas, columnas);
