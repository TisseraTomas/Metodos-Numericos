...
int main(int argc, char *argv[]) {
	double m[9][2] = {{1.00,-0.1483},{1.25,-0.0400},{1.50, 0.1395},{1.75, 0.4493},{2.00, 0.7001}}; //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Aca cargo los datos X , Y
	int filas = 5; //poner aca la cantidad de filas de m. acordate que la cantidad de intervalos es filas-1
